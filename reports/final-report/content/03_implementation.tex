...
Our implementation strategy for the web server was iterative, starting with small, manageable tasks and progressively tackling more complex ones. We regularly tested the code by running it with different inputs to ensure functionality. %TODO: evt. erwähnen dass wir iterativ angefangen haben bei get etc. 
...
\subsection*{CGI}
\textbf{CGI handler}: Environment Variables (as Defined in the Specification). Piping %TODO: evt. example
% pipes 
% env variables 
